  ...
  return (
    <div className="max-w-4xl mx-auto p-6 bg-white shadow-lg rounded-lg min-h-screen">
      ...
      <p className="text-gray-700 mb-4">
        Welcome to BookMosaic! By accessing or using our platform, you agree to
      ...
      <p className="text-gray-700 mb-4">
        You agree not to misuse the platform, engage in unlawful activities, or
        violate intellectual property rights.
      </p>
      <h2 className="text-xl font-semibold mt-6">3. Purchases and Payments</h2>
      <p className="text-gray-700 mb-4">
        All purchases made through BookMosaic are final. We use a secure payment
        gateway to process transactions safely.
      </p>
      <h2 className="text-xl font-semibold mt-6">4. Refund Policy</h2>
      <p className="text-gray-700 mb-4">
        Refunds are only issued in case of duplicate transactions or technical
        errors. Please contact support within 7 days for assistance.
      </p>
      <h2 className="text-xl font-semibold mt-6">5. Intellectual Property</h2>
      <p className="text-gray-700 mb-4">
        All content on BookMosaic, including book descriptions, AI
        recommendations, and UI designs, is protected by copyright laws.
      </p>
      ...
      <p className="text-gray-700 mb-4">
        ...
        contact us at <strong>support@bookmosaic.com</strong>.
      </p>{" "}
    </div>
  );
};

export default Terms; // <-- Renamed export
