...
import AnalogClock from "../features/AnalogClock"; // <-- Corrected path
import MotivationalQuote from "../features/MotivationalQuote"; // <-- Corrected path
import AdminNotes from "../features/AdminNotes"; // <-- Corrected path

export default function AdminDashboard() { // Renamed from Dashboard
