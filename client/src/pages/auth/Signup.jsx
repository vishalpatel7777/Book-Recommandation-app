...
import "../../assets/styles/pages/signup.css"; // This path is correct
// import axios from "axios"; // <-- Unused import removed
import { useNavigate } from "react-router-dom";
import 'react-phone-input-2/lib/style.css';
import ImageUpload from "../../components/user/profile/ImageUpload"; // <-- Corrected path
import CustomAlert from "../../components/common/Alert/CustomAlert"; // <-- Corrected path
import SignupSitting2 from "../../assets/images/siiting.png"; // This path is correct
import SignupSitting1 from "../../assets/images/sitting.png"; // This path is correct
import SignupBg from "../../assets/images/background.png"; // This path is correct
import SignupBook from "../../assets/images/singup-book-box.png"; // This path is correct
          ...
          {step === 2 && (
            <>
              ...
              <input
                ...
                onChange={change}
                onFocus={(e) => e.target.type = 'text'}
                onBlur={(e) => e.targe.type = 'password'}
              />
